...
public class NetworkError extends Throwable {
    ...
    private static final String ERROR_MESSAGE_TIME_OUT = "Connection timed out";
    ...
    public String getAppErrorMessage() {
        if (this.error instanceof IOException) {
            if (this.error.toString().contains("No address associated with hostname")) {
                return NETWORK_ERROR_MESSAGE;
            }
            if (this.error.toString().contains("Connection timed out")) {
                return ERROR_MESSAGE_TIME_OUT;
            }
